...
def execute_model(
    ...
    print(f"execute_model {predicted_sql}")
    try:
...
if __name__ == "__main__":
    ...
    print(f"query_pairs at time {time.time() - start}")
    query_pairs = list(zip(pred_queries, gt_queries))
    print(f"run_sqls_parallel at time {time.time() - start}")
    run_sqls_parallel(
        query_pairs,
        db_places=db_paths,
    ...
    print(f"sorting at time {time.time() - start}")
